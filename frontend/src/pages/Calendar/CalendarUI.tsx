            ...
            <CardContent>
              {selectedDateEvents.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-4 text-lg font-medium">لا توجد أحداث</h3>
                  <p className="mt-2 text-muted-foreground">
                    لا توجد أحداث محددة لهذا اليوم
                  </p>
                </div>
              )}
            </CardContent>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent side="bottom" align="end" className="z-50">
                          <DropdownMenuItem onClick={() => openEditDialog(event)} className="flex items-center gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    <div className="flex items-center gap-1">
                      ...
                      {format(parseISO(event.date), "d MMMM yyyy", { locale: ar })}
                    </div>
