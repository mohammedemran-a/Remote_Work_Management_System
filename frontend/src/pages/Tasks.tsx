  ...
  const handleSubmit = () => {
    if (editId) {
      if (!hasPermission("tasks_edit"))
        return toast({
          title: "خطأ",
          description: "لا تمتلك صلاحية تعديل المهام",
          variant: "destructive",
        });
      ...
      if (!hasPermission("tasks_create"))
        return toast({
          title: "خطأ",
          description: "لا تمتلك صلاحية إنشاء المهام",
          variant: "destructive",
        });
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  value={form.priority}
                  onValueChange={(v) =>
                    setForm({ ...form, priority: v as TaskPayload["priority"] })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({ ...form, assigned_to: Number(v) })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({ ...form, project_id: Number(v) })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <AlertDialogAction
              onClick={() => {
                if (hasPermission("tasks_delete") && deleteId) {
                  ...
                  toast({
                    title: "خطأ",
                    description: "لا تمتلك صلاحية حذف المهام",
                    variant: "destructive",
                  });
                  setDeleteId(null);
                }
